...
Devise.setup do |config|
  ...
  # config.pepper = 'd7bd9234e1a4bce42da808d4e4460f10a2627f9fefff493682d09573df0235101ffc3690aaaa83d5291c43b5f75b7af1a27552b11112af04a39d1f491ac58c48'
  ...
  # config.omniauth :facebook, Rails.application.credentials.facebook[:id], Rails.application.credentials.facebook[:code]
